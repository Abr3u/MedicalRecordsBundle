...
public class createStaff {
	...
	public final void execute(String username, String password, String newUsername) throws ParserConfigurationException, SAXException, IOException, missingDoctorArgumentsException, missingResourceSpecArgumentsException, missingPatientArgumentsException, missingResourceIDArgumentsException, NotEnoughPermissionException, CantLoginException,UsernameDoesntExistException{
		...
		db.createStaffProfile(newUsername);
	}
}
