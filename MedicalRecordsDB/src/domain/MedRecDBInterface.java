...
public interface MedRecDBInterface extends Remote{
	...
	void createStaff(String username, String pass, String newUsername) throws RemoteException, ParserConfigurationException, SAXException, IOException, missingDoctorArgumentsException, missingResourceSpecArgumentsException, missingPatientArgumentsException, missingResourceIDArgumentsException, NotEnoughPermissionException, CantLoginException, UsernameDoesntExistException;
	...
	void changeEmergencyStatus(String username, String password, String doc,boolean e) throws CantLoginException, UsernameDoesntExistException, ParserConfigurationException, SAXException, IOException, missingDoctorArgumentsException, missingResourceSpecArgumentsException, missingPatientArgumentsException, missingResourceIDArgumentsException, NotEnoughPermissionException;
	boolean checkRecord(String username, String password,String patientName) throws CantLoginException, UsernameDoesntExistException, NoSuchAlgorithmException, ParserConfigurationException, SAXException, IOException, missingDoctorArgumentsException, missingResourceSpecArgumentsException, missingPatientArgumentsException, missingResourceIDArgumentsException, NotEnoughPermissionException;
	boolean checkDoctorSign(String username, String pass, String docName, String entry) throws RemoteException, CantLoginException, UsernameDoesntExistException, invalidEntryException, NotEnoughPermissionException, ParserConfigurationException, SAXException, IOException, missingDoctorArgumentsException, missingResourceSpecArgumentsException, missingPatientArgumentsException, missingResourceIDArgumentsException;
	String getEmergencyMode(String username) throws RemoteException;
}
